...
%@% END-IF %@%
  ...
  \section{DESCRIPTION}
      ...
      when provided to \Prog{gourd}, can be used to create a new \emph{experiment}.
  ...
  \section{GLOBAL CONTEXT}
    ...
    \begin{Description}[Options]\setlength{\itemsep}{0cm}
        ...
        \item[\Opt{metrics\_path} = path]
            Where to store the metrics for \Prog{gourd} \Arg{status}.
...
%      \end{Description}
    ...
    \section{INPUTS}
      ...
      A \Prog{gourd} experiment consists of a cross-product mapping between programs
      and inputs.
