    ...
    \subsection{GOURD CANCEL}
        ...
        \subsection{GOURD ANALYSE}
            ...
            \subsubsection{Metrics CSV}
                Running \Prog{gourd} \Arg{analyse} will create a CSV file with data about the status of
                the runs, metrics, and afterscript completion, unless there are no runs that have completed
                already. 
            ...
            \subsubsection{Cactus plots}
                Running \Prog{gourd} \Arg{analyse} will also create a PNG picture of a cactus plot.
