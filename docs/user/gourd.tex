...
%@% END-IF %@%
    ...
    \section{COMMANDS}
        ...
        \begin{Description}[Commands]
            ...
            Schedule the rest of the experiment if the Slurm job limit prevented that.
        ...
        \subsection{GOURD RUN}
            ...
            \subsubsection{Summary}
                ...
                See the manual page for \Prog{gourd-tutorial}(1) for a step-by-step guide on
        ...
        \subsection{GOURD INIT}
            ...
            \subsubsection{Options}
                ...
                Initializes the given directory with an example configuration from \Prog{gourd-tutorial}(1)
        ...
        \subsection{GOURD CONTINUE}
            ...
            \subsubsection{Summary}
                ...
                For example, if the Slurm job limit is 10000 (as is the case on DelftBlue), an
                experiment with 10 programs and 3000 inputs will need 3 batches to fully execute.

                \Prog{gourd} \Arg{continue} when ran reports on the status of the exeperiment:
                \begin{verbatim}
                  > gourd continue
                  Continuing experiment... 1500 new jobs scheduled, 1500 left (75\% scheduled)
                  >
                \end{verbatim}
